...
describe("Functional test for building the Events URL", function() {
	it('Test URL', function (done) {
		...
		assert.equal(url,"https://"+configManager.getController()+"/controller/#/location=APP_INCIDENT_LIST&timeRange=Custom_Time_Range.BETWEEN_TIMES.1475297999999.1475211600000.1439&application=143");
		done();
	});
});
